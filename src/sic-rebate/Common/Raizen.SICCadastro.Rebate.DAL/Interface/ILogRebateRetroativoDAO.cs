...
// <Summary>
// File Name            : ILogRebateRetroativoDAO.cs
// Class Name           : ILogRebateRetroativoDAO
...
{
    /// <summary>
    /// Interface de acesso a dados para LogRebateRetroativo
    /// </summary>
    public interface ILogRebateRetroativoDAO
    {
        ...
        IList<LogRebateRetroativo> SelecionarTodos();
