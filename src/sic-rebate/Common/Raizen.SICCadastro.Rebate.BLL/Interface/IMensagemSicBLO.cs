...
// <Summary>
// File Name		    : IMensagemSicBLO.cs
// Class Name	        : IMensagemSicBLO
// Author		        : Romildo Cruz
...
{
	/// <summary>
	/// Representa funcionalidade relacionada a IMensagemSicBLO
	/// </summary>
	public interface IMensagemSicBLO
	{
		#region Metodos de IMensagemSicBLO 
		...
		/// <param name="ordem">Ordem dos dados retornados ou branco/nulo para ordem padrão</param>
		/// <returns>Retorna lista de MensagemSic</returns>
		IList<MensagemSic> Selecionar(MensagemSic mensagemSic, string ordem);
		...
		/// <param name="mensagemSic">Instância de <see cref="MensagemSic"/> para filtrar os dados</param>
		/// <returns>Retorna lista de MensagemSic</returns>
		IList<MensagemSic> Selecionar(MensagemSic mensagemSic);
		
		/// <summary>
		/// Selecionar os dados de MensagemSic
		/// </summary>
		/// <returns>Retorna lista de MensagemSic</returns>
		IList<MensagemSic> Selecionar();
		...
		MensagemSic SelecionarPrimeiro(MensagemSic mensagemSic);
