...
namespace Raizen.SICCadastro.Rebate.BLL
{
	...
	public partial interface ISaldoRebateSicBLO
	{
		...
		/// <param name="ordem">Ordem dos dados retornados ou branco/nulo para ordem padrão</param>
		/// <returns>Retorna lista de SaldoRebateSic</returns>
		IList<SaldoRebateSic> Selecionar(SaldoRebateSic saldoRebateSic, string ordem);
		...
		/// <param name="saldoRebateSic">Instância de <see cref="SaldoRebateSic"/> para filtrar os dados</param>
		/// <returns>Retorna lista de SaldoRebateSic</returns>
		IList<SaldoRebateSic> Selecionar(SaldoRebateSic saldoRebateSic);
		
		/// <summary>
		/// Selecionar os dados de SaldoRebateSic
		/// </summary>
		/// <returns>Retorna lista de SaldoRebateSic</returns>
		IList<SaldoRebateSic> Selecionar();
		...
		SaldoRebateSic SelecionarPrimeiro(SaldoRebateSic saldoRebateSic);
