...
// <Summary>
// File Name		    : IAgrupamentoredeRebateSicBLO.cs
// Class Name	        : IAgrupamentoredeRebateSicBLO
...
{
	/// <summary>
	/// Representa funcionalidade relacionada a IAgrupamentoredeRebateSicBLO
	/// </summary>
	public interface IAgrupamentoredeRebateSicBLO
	{
		#region Metodos de IAgrupamentoredeRebateSicBLO 
		...
		/// <param name="ordem">Ordem dos dados retornados ou branco/nulo para ordem padrão</param>
		/// <returns>Retorna lista de AgrupamentoredeRebateSic</returns>
		IList<AgrupamentoredeRebateSic> Selecionar(AgrupamentoredeRebateSic agrupamentoredeRebateSic, string ordem);
		...
		/// <param name="agrupamentoredeRebateSic">Instância de <see cref="AgrupamentoredeRebateSic"/> para filtrar os dados</param>
		/// <returns>Retorna lista de AgrupamentoredeRebateSic</returns>
		IList<AgrupamentoredeRebateSic> Selecionar(AgrupamentoredeRebateSic agrupamentoredeRebateSic);
		
		/// <summary>
		/// Selecionar os dados de AgrupamentoredeRebateSic
		/// </summary>
		/// <returns>Retorna lista de AgrupamentoredeRebateSic</returns>
		IList<AgrupamentoredeRebateSic> Selecionar();
		...
		AgrupamentoredeRebateSic SelecionarPrimeiro(AgrupamentoredeRebateSic agrupamentoredeRebateSic);
		...
		#endregion IAgrupamentoredeRebateSicBLO
	}
}
