...
// <Summary>
// File Name		    : IStatusCalculoRebateSicBLO.cs
// Class Name	        : IStatusCalculoRebateSicBLO
...
{
	/// <summary>
	/// Representa funcionalidade relacionada a IStatusCalculoRebateSicBLO
	/// </summary>
	public partial interface IStatusCalculoRebateSicBLO
	{
		#region Metodos de IStatusCalculoRebateSicBLO 
		...
		/// <param name="ordem">Ordem dos dados retornados ou branco/nulo para ordem padrão</param>
		/// <returns>Retorna lista de StatusCalculoRebateSic</returns>
		IList<StatusCalculoRebateSic> Selecionar(StatusCalculoRebateSic statusCalculoRebateSic, string ordem);
		...
		/// <param name="statusCalculoRebateSic">Instância de <see cref="StatusCalculoRebateSic"/> para filtrar os dados</param>
		/// <returns>Retorna lista de StatusCalculoRebateSic</returns>
		IList<StatusCalculoRebateSic> Selecionar(StatusCalculoRebateSic statusCalculoRebateSic);
		
		/// <summary>
		/// Selecionar os dados de StatusCalculoRebateSic
		/// </summary>
		/// <returns>Retorna lista de StatusCalculoRebateSic</returns>
		IList<StatusCalculoRebateSic> Selecionar();
		...
		StatusCalculoRebateSic SelecionarPrimeiro(StatusCalculoRebateSic statusCalculoRebateSic);
		...
		#endregion IStatusCalculoRebateSicBLO
	}
}
