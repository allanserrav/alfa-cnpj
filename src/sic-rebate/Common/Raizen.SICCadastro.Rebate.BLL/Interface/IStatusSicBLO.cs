...
// <Summary>
// File Name		    : IStatusSicBLO.cs
// Class Name	        : IStatusSicBLO
...
{
	/// <summary>
	/// Representa funcionalidade relacionada a IStatusSicBLO
	/// </summary>
	public partial interface IStatusSicBLO
	{
		#region Metodos de IStatusSicBLO 
		...
		/// <param name="ordem">Ordem dos dados retornados ou branco/nulo para ordem padrão</param>
		/// <returns>Retorna lista de StatusSic</returns>
		IList<StatusSic> Selecionar(StatusSic statusSic, string ordem);
		...
		/// <param name="statusSic">Instância de <see cref="StatusSic"/> para filtrar os dados</param>
		/// <returns>Retorna lista de StatusSic</returns>
		IList<StatusSic> Selecionar(StatusSic statusSic);
		
		/// <summary>
		/// Selecionar os dados de StatusSic
		/// </summary>
		/// <returns>Retorna lista de StatusSic</returns>
		IList<StatusSic> Selecionar();
		...
		StatusSic SelecionarPrimeiro(StatusSic statusSic);
