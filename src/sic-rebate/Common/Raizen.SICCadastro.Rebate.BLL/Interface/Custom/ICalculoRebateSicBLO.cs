...
namespace Raizen.SICCadastro.Rebate.BLL
{
    ...
    public partial interface ICalculoRebateSicBLO
    {
        ...
        CalculoRebateSic SelecionarUltimo(CalculoRebateSic calculoRebateSic);
        ...
        void ExcluirCalculoUltimoPeriodo(RebateSic rebateSic, DateTime dataPeriodo, DateTime dataInicio, DateTime dataFim);
        #endregion
        ...
        #region SelecionarRebatesSemCalculo
        /// <summary>
        /// Seleciona uma lista de bonificação
        /// </summary>
        /// <param name="filtro">filtro</param>
