...
// <Summary>
// File Name		    : IClientestatusSicBLO.cs
// Class Name	        : IClientestatusSicBLO
...
{
	/// <summary>
	/// Representa funcionalidade relacionada a IClientestatusSicBLO
	/// </summary>
	public partial interface IClientestatusSicBLO
	{
		#region Metodos de IClientestatusSicBLO 
		...
		/// <param name="ordem">Ordem dos dados retornados ou branco/nulo para ordem padrão</param>
		/// <returns>Retorna lista de ClientestatusSic</returns>
		IList<ClientestatusSic> Selecionar(ClientestatusSic clientestatusSic, string ordem);
		...
		/// <param name="clientestatusSic">Instância de <see cref="ClientestatusSic"/> para filtrar os dados</param>
		/// <returns>Retorna lista de ClientestatusSic</returns>
		IList<ClientestatusSic> Selecionar(ClientestatusSic clientestatusSic);
		
		/// <summary>
		/// Selecionar os dados de ClientestatusSic
		/// </summary>
		/// <returns>Retorna lista de ClientestatusSic</returns>
		IList<ClientestatusSic> Selecionar();
		...
		ClientestatusSic SelecionarPrimeiro(ClientestatusSic clientestatusSic);
		...
		#endregion IClientestatusSicBLO
	}
}
